...
from lawgpt.exceptions import SelfDefinedException
...
class CustomJSONResponse(Response):
    ...
    def render(self, content: typing.Any) -> bytes:
        if not isinstance(content, ResponseWrapper):
            content = ResponseWrapper(code=self.status_code, message=get_http_message(
                self.status_code), result=content)
